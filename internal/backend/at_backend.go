...
// ReloadSIMAfterSwitch is an AT-only capability; QMI/MBIM keep their own
// card-refresh mechanisms.
func (a *ATBackend) ReloadSIMAfterSwitch(ctx context.Context) error {
	return a.modem.ReloadSIMAfterSwitch(ctx)
}
