...
func (m *RealtimeManager) defaultReaderForDevice(deviceID string) (realtimeCounterReader, error) {
	...
	if w.ECMCore != nil {
		...
		return realtimeCounterReader{DeviceID: w.ID, Interface: iface, Source: trafficCounterSourceInterface, ReadCounters: func(ctx context.Context) (trafficCounters, error) { return readInterfaceTrafficCounters(ctx, iface) }}, nil
	}
	if w.QMICore == nil {
